      ...
      <section id="features" className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {["Secure Auth", "Fast UI", "Responsive"].map((title) => (
            <div
              key={title}
              className="p-5 rounded-xl bg-slate-900 border border-slate-700 shadow-sm hover:-translate-y-1 hover:shadow-md transition"
            >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            ...
            >
              ...
              <h3 className="font-semibold text-white">Sample Product {i}</h3>
              <p className="text-xs text-slate-500">
                Short one-line description for product {i}...
              </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="p-5 rounded-xl bg-slate-900 border border-slate-700">
              ...
              <p className="text-sm font-semibold text-white">User {i}</p>
